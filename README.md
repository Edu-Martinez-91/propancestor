...
- **Panel "actas a buscar".** Lista de las próximas partidas con un sólo botón a la sede electrónica del Ministerio de Justicia y guía paso a paso para rellenar el formulario, más un desplegable de acceso directo a archivos parroquiales por archidiócesis (de momento solo Toledo, con enlace verificado).
...
- **Tiempos de respuesta por pueblo.** Pestaña "Tiempos" con la media de días que tarda en contestar el Registro Civil de cada pueblo, calculada sobre las actas que ya completaron el ciclo solicitud → obtención, ordenada de más lenta a más rápida. Subsección "Actas obtenidas recientemente" en la página de Actas a buscar para deshacer una marca por error, indicando manualmente cuántos días llevaba en espera.
