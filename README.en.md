...
- **"Records to find" panel.** A list of the next records to chase, with a one-click link to the Spanish Ministry of Justice's online portal and a step-by-step guide for filling out the request form, plus a dropdown linking directly to parish archive request forms by archdiocese (only Toledo for now, with a verified link).
