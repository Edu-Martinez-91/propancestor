...
- **"Record requested" tick.** A per-person waiting-day counter, resettable when you re-request from a different archive. It closes automatically once you enter the exact date.
