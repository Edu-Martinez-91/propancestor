...
- **Response time per town.** "Tiempos" tab showing the average number of days the Civil Registry of each town takes to answer, computed from records that completed the full requested → obtained cycle, sorted slowest first.
